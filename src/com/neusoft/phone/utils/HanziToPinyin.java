...
public class HanziToPinyin {
    ...
    private final static byte[][] PINYINS = {
        { 65,   0,   0,   0,   0,   0}, { 65,  73,   0,   0,   0,   0}, //a ,ai
        { 65,  78,   0,   0,   0,   0}, { 65,  78,  71,   0,   0,   0}, //an ,ang
        { 65,  79,   0,   0,   0,   0}, { 66,  65,   0,   0,   0,   0}, //ao ,ba
        { 66,  65,  73,   0,   0,   0}, { 66,  65,  78,   0,   0,   0}, //bai ,ban
        { 66,  65,  78,  71,   0,   0}, { 66,  65,  79,   0,   0,   0}, //bang ,bao
        { 66,  69,  73,   0,   0,   0}, { 66,  69,  78,   0,   0,   0}, //bei ,ben
        { 66,  69,  78,  71,   0,   0}, { 66,  73,   0,   0,   0,   0}, //beng ,bi
        { 66,  73,  65,  78,   0,   0}, { 66,  73,  65,  79,   0,   0}, //bian ,biao
        { 66,  73,  69,   0,   0,   0}, { 66,  73,  78,   0,   0,   0}, //bie ,bin
        { 66,  73,  78,  71,   0,   0}, { 66,  79,   0,   0,   0,   0}, //bing ,bo
        { 66,  85,   0,   0,   0,   0}, { 67,  65,   0,   0,   0,   0}, //bu ,ca
        { 67,  65,  73,   0,   0,   0}, { 67,  65,  78,   0,   0,   0}, //cai ,can
        { 67,  65,  78,  71,   0,   0}, { 67,  65,  79,   0,   0,   0}, //cang ,cao
        { 67,  69,   0,   0,   0,   0}, { 67,  69,  78,   0,   0,   0}, //ce ,cei
    ...
    private static final String NUMBER_PINYIN = "";
    private static final String UNKNOWN_PINYIN = "";

    /** The first Chinese character in Unicode block */
    private static final char FIRST_UNIHAN = '\u3400';
    private static final char HALF_0 = '\u0030';
    private static final char HALF_9 = '\u0039';
    private static final char HALF_SMALL_A = '\u0061';
    private static final char HALF_SMALL_Z = '\u007a';
    private static final char HALF_BIG_A = '\u0041';
    private static final char HALF_BIG_Z = '\u005a';

    private static final char FULL_0 = '\uff10';
    private static final char FULL_9 = '\uff19';
    private static final char FULL_SMALL_A = '\uff41';
    private static final char FULL_SMALL_Z = '\uff5a';
    private static final char FULL_BIG_A = '\uff21';
    private static final char FULL_BIG_Z = '\uff3a';
    ...
    public static class Token {
        ...
        public static final int FULL_NUM = 2;
        public static final int HALF_SMALL_LET = 3;
        public static final int HALF_BIG_LET = 4;
        public static final int FULL_SMALL_LET = 5;
        public static final int FULL_BIG_LET = 6;
        public static final int PINYIN = 7;
    ...
    private Token getToken(char character) {
        ...
        int offset = -1;
        int cmp;
        if((character>=HALF_0)&&(character<=HALF_9)){
            token.type = Token.HALF_NUM;
            token.target = NUMBER_PINYIN;
            token.source = letter;
            return token;
        }
        else if((character>=HALF_SMALL_A)&&(character<=HALF_SMALL_Z)){
            token.type = Token.HALF_SMALL_LET;
            token.target = Character.toString((char) (character-HALF_SMALL_A+HALF_BIG_A));
            token.source = letter;
            return token;
        }
        else if((character>=HALF_BIG_A)&&(character<=HALF_BIG_Z)){
            token.type = Token.HALF_BIG_LET;
            token.target = letter;
            token.source = letter;
            return token;
        }
        else if((character>=FULL_0)&&(character<=FULL_9)){
            token.type = Token.FULL_NUM;
            token.target = NUMBER_PINYIN;
            token.source = letter;
            return token;
        }
        else if((character>=FULL_SMALL_A)&&(character<=FULL_SMALL_Z)){
            token.type = Token.FULL_SMALL_LET;
            token.target = Character.toString((char) (character-FULL_SMALL_A+HALF_BIG_A));
            token.source = letter;
            return token;
        }
        else if((character>=FULL_BIG_A)&&(character<=FULL_BIG_Z)){
            token.type = Token.FULL_BIG_LET;
            token.target = Character.toString((char) (character-FULL_BIG_A+HALF_BIG_A));
            token.source = letter;
            return token;
        }
        else if (character < FIRST_UNIHAN) {
            token.type = Token.UNKNOWN;
            token.target = UNKNOWN_PINYIN;
            token.source = letter;
            return token;
        }
        else {
